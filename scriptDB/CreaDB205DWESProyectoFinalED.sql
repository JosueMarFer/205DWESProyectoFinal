CREATE DATABASE IF NOT EXISTS DB205DWESProyectoFinal;
...
CREATE USER IF NOT EXISTS 'user205DWESProyectoFinal'@'%' IDENTIFIED BY 'paso';

GRANT ALL PRIVILEGES ON DB205DWESProyectoFinal.* TO 'user205DWESProyectoFinal'@'%';
